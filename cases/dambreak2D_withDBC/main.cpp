...
int main(){
  ...
  WCSPHfluid.initializeWithGeometryFile("/home/tomas/Documents/testovaci/cpp/TINYSPH_lib/cases/dambreak2D_withDBC/dambreak_fluid.ptcs");
  			std::cout << "Number of fluid particles: " << WCSPHfluid.N << std::endl;

  //Read boundary data
  BoundVars<double, double> WCSPHbound;
  WCSPHbound.initializeWithGeometryFile("/home/tomas/Documents/testovaci/cpp/TINYSPH_lib/cases/dambreak2D_withDBC/dambreak_wall.ptcs");
...
VerletScheme WCSPHVerletProv(&WCSPHbound, 0.000035);
