...
SaveResults=/home/tomas/Documents/temp/tinySPH_dev/dambreak2D_withMDBC
...
### Generate
python generateDamBreakGeometryWithMDBC.py
...
#Ghost
python ../../tools/PTCStoVTK.py -input="dambreak_ghostNodes.ptcs" -output="dambreak_ghostNodes.vtk"
...
cd ../../build/dambreak2D_withMDBC
make
time ./../../build/dambreak2D_withMDBC/dambreak2D_mDBC
