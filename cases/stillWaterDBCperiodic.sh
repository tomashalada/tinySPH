...
SaveResults=/home/tomas/Documents/temp/tinySPH_glob/DBCpbc
CaseFolder=/home/tomas/Documents/testovaci/cpp/TINYSPH_lib/cases/stillwater2D_withDBC_periodic
...
for i in $geometries; do
  ...
  cd ../../build/stillwater2D_withDBC_periodic
  make
  time ./../../build/stillwater2D_withDBC_periodic/stillwater2D_DBC_periodic
  echo ... OK
