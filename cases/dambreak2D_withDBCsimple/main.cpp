...
int main(){
  ...
  WCSPHfluid.initializeWithGeometryFile("/home/tomas/Documents/testovaci/cpp/TINYSPH_lib/cases/dambreak2D_withDBCsimple/dambreak_fluid.ptcs");
  			std::cout << "Number of fluid particles: " << WCSPHfluid.N << std::endl;

  //Read boundary data
  BoundVars<double, double> WCSPHbound;
  WCSPHbound.initializeWithGeometryFile("/home/tomas/Documents/testovaci/cpp/TINYSPH_lib/cases/dambreak2D_withDBCsimple/dambreak_wall.ptcs");
...
VerletScheme WCSPHVerlet(&WCSPHfluid, 0.00003); //0.000035 for multilayers
VerletScheme WCSPHVerletProv(&WCSPHbound, 0.00003);
