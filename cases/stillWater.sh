...
#
#-------------------------------------------------------------------------------------#
# Still water with DBC:

SaveResults=/home/tomas/Documents/temp/tinySPH_glob/DBC
CaseFolder=/home/tomas/Documents/testovaci/cpp/TINYSPH_lib/cases/stillwater2D_withDBC
...
for i in $geometries; do
  ...
  cd ../../build/stillwater2D_withDBC
  make
  time ./../../build/stillwater2D_withDBC/stillwater2D_DBC
  echo ... OK
...
#-------------------------------------------------------------------------------------#
# Still water with MDBC and periodic BC:

SaveResults=/home/tomas/Documents/temp/tinySPH_glob/MDBCpbc
CaseFolder=/home/tomas/Documents/testovaci/cpp/TINYSPH_lib/cases/stillwater2D_withMDBC_periodic
...
for i in $geometries; do
  ...
  echo Compile and run the case.
  cd ../../build/stillwater2D_withMDBC_periodic
  make
  time ./../../build/stillwater2D_withMDBC_periodic/stillwater2D_mDBC_periodic
  echo ... OK
